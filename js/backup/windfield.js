...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Handle CSS variable updates globally
    const root = document.documentElement;
    const observer = new MutationObserver(() => {
        length_min = parseFloat(getComputedStyle(root).getPropertyValue('--_windfield---wf_length_min').trim());
        length_max = parseFloat(getComputedStyle(root).getPropertyValue('--_windfield---wf_length_max').trim());
        weight_min = parseFloat(getComputedStyle(root).getPropertyValue('--_windfield---wf_weight_min').trim());
        weight_max = parseFloat(getComputedStyle(root).getPropertyValue('--_windfield---wf_weight_max').trim());
        rotation_factor = parseFloat(getComputedStyle(root).getPropertyValue('--_windfield---wf_rotation').trim());
    });
